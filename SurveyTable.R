...
survsumtable <- data.frame(
  Variable = c("I would find the food delivery app useful for my needs",
               "Using the app enables me to order food more quickly and efficiently",
               "Using the app increases my satisfaction with the food delivery process",
               "If I use the app, I believe it will enhance my overall dining experience",
               "My interaction with the app would be clear and understandable",
               "It would be easy for me to become skillful at using the app",
               "I would find the app easy to navigate and use",
